<template>
  <div class="app-page">
    ...
    <v-row class="app-grid">
      <v-col class="app-page__section-title" cols="12">{{ $t('basic.routing.title') }}</v-col>
    <v-col cols="12">
      <v-row>
    ...
    <v-row class="app-grid">
      <v-col class="app-page__section-title" cols="12">{{ $t('rule.ruleset') }}</v-col>
      <v-col cols="12" md="6" lg="4" xl="3" v-for="(item, index) in <any[]>rulesets" :key="item.tag">
        <v-card class="app-entity-card" elevation="5" :title="item.tag">
        ...
        <v-divider></v-divider>
          ...
          <v-btn icon="mdi-file-remove" color="warning" @click="delRulesetOverlay[index] = true">
    ...
    <v-row class="app-grid">
      <v-col class="app-page__section-title" cols="12">{{ $t('pages.rules') }}</v-col>
      <v-col cols="12" md="6" lg="4" xl="3" v-for="(item, index) in <any[]>rules"
        :key="item.id" :draggable="true"
        @dragstart="onDragStart(index)" @dragover.prevent @drop="onDrop(index)">
        <v-card class="app-entity-card" elevation="5" :title="index+1">
          <v-card-subtitle class="app-entity-card__subtitle">
        ...
        <v-divider></v-divider>
          ...
          <v-btn icon="mdi-file-remove" color="warning" @click="delRuleOverlay[index] = true">
            <v-icon /><v-tooltip activator="parent" location="top" :text="$t('actions.del')"></v-tooltip>
          </v-btn>

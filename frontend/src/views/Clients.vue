  ...
  <div class="app-page">
    <section class="app-page__hero">
      <div class="app-page__hero-head">
        <div class="app-page__hero-kicker">{{ $t('pages.clients') }}</div>
        <h1 class="app-page__hero-title">{{ $t('pages.clients') }}</h1>
        <p class="app-page__hero-copy">
          Review provisioned identities, inbound bindings, expiry posture, and live connection state from a single operator view.
        </p>
      ...
      <div class="app-page__hero-side">
        <div class="app-page__hero-stats">
          <div class="app-page__hero-stat">
            ...
            <span class="app-page__hero-stat-note">Connected identities right now</span>
          </div>
          <div class="app-page__hero-stat">
            <span class="app-page__hero-stat-label">{{ $t('date.expiry') }}</span>
            <strong class="app-page__hero-stat-value">{{ expiredCount }}</strong>
            <span class="app-page__hero-stat-note">Clients already past their validity window</span>
          </div>
        </div>
      </div>
    </section>
              ...
              <v-container>
                ...
                <v-row>
                  <v-col>
                    ...
                    :items="[ {title: $t('all'), value: '-'}, ...groups.map(g => ({ title: (g?.length ?? 0)>0 ? g : $t('none'), value: g ?? '' }))]"
    ...
    <v-row class="app-grid">
      <v-col cols="12">
        <v-data-table
          ...
          :hide-default-footer="filteredClients.length<=10"

...
func TestClusterServiceListDomainsIncludesSupportedActions(t *testing.T) {
	...
	expectedActions := []string{"domain.cluster.changed", "events", "heartbeat", "ping", "info", "action", "domain.panel.update.available", "domain.panel.update.request", "domain.panel.update.status", "domain.inbound.create", "domain.inbound.update", "domain.inbound.delete"}

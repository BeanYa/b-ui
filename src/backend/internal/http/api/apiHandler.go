...
func (a *APIHandler) initRouter(g *gin.RouterGroup) {
	...
	g.GET("/cluster/member-connection", a.getClusterMemberConnection)
	g.GET("/cluster/member-info", a.getClusterMemberInfo)
	...
	g.GET("/cluster/domains/:id/resources", a.listClusterDomainResources)
	g.POST("/cluster/domains/:id/resources/inbounds", a.createClusterDomainInboundResource)
	g.PUT("/cluster/domains/:id/resources/inbounds/:groupId", a.updateClusterDomainInboundResource)
	g.DELETE("/cluster/domains/:id/resources/inbounds/:groupId", a.deleteClusterDomainInboundResource)
	g.POST("/cluster/domains/:id/resources/users", a.createClusterDomainUserResource)
	...
	g.GET("/cluster/domains/:id/tasks/:taskId/result", a.getClusterScatterTaskResult)
	g.DELETE("/cluster/domains/:id", a.leaveClusterDomain)
	g.DELETE("/cluster/members/:id", a.deleteClusterMember)
	g.GET("/cluster/logs", a.getClusterLogs)
	g.POST("/setting/region/fetch", a.ApiService.FetchRegion)

export default {
  ...
  clusterCenter: {
    ...
    heroCopy: "دامنه‌ها را در Hub ثبت کنید، اعضای آینه‌شده را ببینید و همگام‌سازی را به‌صورت دستی اجرا کنید.",
    ...
    dialogTitle: "ثبت / پیوستن به دامنه",
    fields: {
      domain: "دامنه",
      hubUrl: "آدرس Hub",
      token: "توکن دامنه",
      baseUrl: "Base URL این نود",
      name: "نام نمایشی",
    },
    table: {
      node: "نود",
    ...
    validation: {
      required: "دامنه، آدرس Hub، توکن دامنه و Base URL این نود الزامی هستند.",
      hubUrl: "آدرس Hub باید یک URL کامل باشد و به‌جز localhost از https استفاده کند.",
      baseUrl: "Base URL این نود باید یک URL کامل باشد و به‌جز localhost از https استفاده کند.",
    },
    successRegistered: "ثبت دامنه خوشه تکمیل شد.",
  },
  client: {
    name: "نام",
    desc: "شرح",

export default {
  ...
  clusterCenter: {
    ...
    heroCopy: "Register domains against the Hub, inspect mirrored membership, and trigger explicit sync cycles from one segmented control surface.",
    metaNoDomain: "No domain selected",
    domainsTitle: "Domains",
    noDomains: "No domains registered yet.",
    ...
    dialogTitle: "Register / Join Domain",
    fields: {
      domain: "Domain",
      hubUrl: "Hub URL",
      token: "Domain Token",
      baseUrl: "This Node Base URL",
      name: "Display Name",
    },
    table: {
      node: "Node",
    ...
    validation: {
      required: "Domain, Hub URL, Domain Token, and This Node Base URL are required.",
      hubUrl: "Hub URL must be an absolute URL and use https unless it is localhost.",
      baseUrl: "This Node Base URL must be an absolute URL and use https unless it is localhost.",
    },
    successRegistered: "Cluster domain registration completed.",
  },
  client: {
    name: "Name",
    desc: "Description",

export default {
  ...
  clusterCenter: {
    ...
    alreadyExists: "This panel URL already exists in the domain.",
    alreadyExistsHint: "Would you like to pull the latest domain information instead?",
    pullDomain: "Pull Domain Info",

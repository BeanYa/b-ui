export default {
  ...
  clusterCenter: {
    ...
    heroCopy: "Đăng ký miền vào Hub, xem các nút được đồng bộ và kích hoạt đồng bộ thủ công từ một bảng điều khiển duy nhất.",
    metaNoDomain: "Chưa chọn miền",
    domainsTitle: "Miền",
    noDomains: "Chưa có miền nào được đăng ký.",
    ...
    dialogTitle: "Đăng ký / tham gia miền",
    fields: {
      domain: "Miền",
      hubUrl: "URL Hub",
      token: "Token miền",
      baseUrl: "Base URL của nút này",
      name: "Tên hiển thị",
    },
    table: {
      node: "Nút",
    ...
    actions: {
      register: "Đăng ký / tham gia miền",
    ...
    validation: {
      required: "Miền, URL Hub, token miền và Base URL của nút này là bắt buộc.",
      hubUrl: "URL Hub phải là URL tuyệt đối và dùng https, trừ localhost.",
      baseUrl: "Base URL của nút này phải là URL tuyệt đối và dùng https, trừ localhost.",
    },
    successRegistered: "Đăng ký miền cụm đã hoàn tất.",
  },
  client: {
    name: "Tên",
    desc: "Mô tả",

export default {
  ...
  pages: {
    ...
    clusterScatterTaskResult: "分發任務結果",
    multiLocationPing: "多地延遲測試",
    webTerminal: "WebTerminal",
  },
  webTerminal: {
    heroCopy: "在瀏覽器中開啟終端會話，無需離開管理介面即可檢查本機終端後端串流。",
    connectionStatus: "連線狀態",
    interactiveStream: "互動式 TTY 串流",
    transcript: "終端記錄",
    connect: "連線",
    disconnect: "中斷連線",
    placeholder: "連線後開始互動式終端會話。",
    activationTitle: "互動式 Web 終端",
    activationCopy: "啟動即時終端會話，支援鍵盤互動、游標渲染與串流輸出。",
    connectTitle: "連線 Web 終端？",
    connectCopy: "這將開啟伺服器上的即時 shell 會話，並允許在瀏覽器內進行即時鍵盤互動。",
    stay: "留在此頁",
    leaveTitle: "離開 WebTerminal？",
    leaveCopy: "離開此頁面將關閉目前終端會話，並可能中斷伺服器上正在執行的命令或任務。",
    leaveAndAbort: "離開並中止",
    terminalOpening: "正在開啟終端連線...",
    terminalConnected: "終端已連線。",
    terminalDisconnected: "終端已中斷連線。",
    terminalConnectionError: "終端連線錯誤。",
    terminalMalformedMessage: "已忽略格式異常的終端訊息。",
    terminalAborted: "由於你離開頁面，終端已中止。",
    terminalStartPrompt: "點擊連線以開始互動式終端會話。",
    beforeUnload: "離開 WebTerminal 將關閉目前終端會話並中斷正在執行的任務。",
  },
  main: {
    tiles: "信息卡",
    gauges: "儀表板",
    ...
    backup: {
      ...
      cleanupTitle: "殘留檔案",
      cleanupCaption: "掃描可安全移除的殘留備份、暫存及遷移檔案。",
      scan: "掃描",
      noResidual: "未發現殘留檔案。",
      deleteSelected: "刪除 ({n})",
      kind_backup: "備份回滾檔",
    ...
    updatePanel: {
      ...
      latestVersion: "最新版本",
      targetVersion: "目標版本",
      confirmUpdate: "偵測到新版本，確認後將自動更新面板到最新發佈版本。",
      confirmForce: "目前版本已與最新發佈版本相同。如需重新安裝目前版本，請執行強制更新。",
      confirmDowngrade: "目前版本高於最新發佈版本。繼續將執行強制更新並重新安裝最新發佈版本。",
      confirmUnknown: "暫時無法準確比較目前版本與最新版本。繼續將執行強制更新。",
      unsupported: "目前執行環境暫不支援面板自動更新。",
      progress: "更新中",
      progressHint: "更新期間面板可能短暫不可用，完成後會自動恢復。",
      running: "正在啟動面板更新任務，請等待服務重新啟動並完成安裝。",
      completed: "面板更新成功。",
      completedWithRefresh: "面板更新成功，請重新整理頁面以載入新版本。",
      failed: "面板更新失敗，請查看下方更新日誌。",
      logPath: "更新日誌：",
      logFile: "更新日誌",
      logPending: "正在等待更新日誌輸出...",
      steps: {
        downloading: "正在下載安裝腳本...",
        installing: "正在執行安裝腳本...",
      },
    },
  },
  ...
  setting: {
    ...
    trafficAge: "流量最大年齡",
    timeLoc: "時區",
    tlsDomainHints: "TLS/Reality 候選網域",
    tlsDomainHintsHint: "每行一個網域。用於內建 SNI 與 Reality 網域檢測清單。",
    subEncode: "啟用編碼",
    subInfo: "啟用用戶信息",
    path: "默認路徑",
    update: "自動更新時間",
    ...
    regionCaption: "偵測或手動地區，用於命名與路由提示。",
  },
  clusterCenter: {
    heroKicker: "叢集工作區",
    ...
    actions: {
      ...
      pingSettings: {
        ...
        interval: "偵測間隔",
        probeMethods: "探測方式",
        alertThreshold: "警報閾值 (ms)",
        concurrency: "並行數",
        saved: "Ping 設定已儲存",
        saveFailed: "Ping 設定儲存失敗",
      },
      confirmDeleteTitle: "確認刪除",
      confirmDeleteMember: "確認將該成員從域中移除？",
      confirmLeaveTitle: "確認退出域",
      confirmLeaveDomain: "確認退出當前域？本機節點將離開此域。",
      confirmForceDeleteTitle: "確認強制刪除",
      confirmForceDeleteMember: "清理失敗。確認只從 Hub 資訊表刪除該成員，並以 Hub 資訊表為準同步節點？",
      confirmForceLeaveDomain: "清理失敗。確認只從 Hub 資訊表移除本機節點，並以 Hub 資訊表為準同步節點？",
    joinUriHint: "URI 以 buihub:// 開頭，例如 buihub://hub.example.com/domain?id=example.com&domain_token=xxx。",
    validation: {
      nodeAddress: "節點位址不能為空。",
      required: "Hub 位址、域Id 與域認證令牌為必填欄位。",
      hubUrl: "Hub 位址必須是絕對 URL，且除 localhost 外必須使用 https。",
      panelUrl: "目前面板位址必須是絕對 URL，且除 localhost 外必須使用 https。",
      displayName: "顯示名稱不能為空。",
      invalidJoinUri: "URI 格式無效，請檢查後重試。",
    },
    displayName: "顯示名稱",
    displayNameHint: "預設使用 Base URL 中的網域，可依需求修改。",
    alreadyExists: "域中已存在相同 Base URL 的節點。",
    alreadyExistsHint: "該節點會被視為同一台伺服器。是否拉取域資料並將該伺服器映射為本機節點？",
    pullDomain: "拉取並映射",
    stepDomainInfo: "域資訊",
  ...
  tls : {
    ...
    quickCreate: "快速建立",
    applyPreset: "套用模板",
    domainCandidates: "SNI 網域候選",
    refreshHints: "重新整理網域檢測",
    presets: {
      standard: "TLS",
      hysteria2: "Hysteria2",
      reality: "Reality",
      standardCert: "TLS-憑證",
      hysteria2Cert: "Hysteria2-憑證",
    },
    status: {
      builtin: "內建",
      recommended: "推薦",

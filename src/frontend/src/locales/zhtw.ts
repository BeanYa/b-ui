export default {
  ...
  clusterCenter: {
    heroKicker: "叢集工作區",
    heroCopy: "在統一控制台中向 Hub 註冊域、查看鏡像成員，並手動觸發同步。",
    metaNoDomain: "尚未選擇域",
    domainsTitle: "域列表",
    noDomains: "目前還沒有已註冊域。",
    selectDomain: "選擇一個域",
    ...
    validation: {
      required: "域名、Hub 位址、域 Token 與本節點 Base URL 為必填欄位。",
      hubUrl: "Hub 位址必須是絕對 URL，且除 localhost 外必須使用 https。",
      baseUrl: "本節點 Base URL 必須是絕對 URL，且除 localhost 外必須使用 https。",
    },
    successRegistered: "叢集域註冊已完成。",
  },
  client: {
    name: "名稱",
    desc: "描述",

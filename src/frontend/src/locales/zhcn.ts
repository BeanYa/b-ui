export default {
  ...
  clusterCenter: {
    heroKicker: "集群工作区",
    heroCopy: "在统一控制台中向 Hub 注册域、查看镜像成员，并显式触发同步。",
    metaNoDomain: "未选择域",
    domainsTitle: "域列表",
    noDomains: "当前还没有已注册域。",
    selectDomain: "选择一个域",
    ...
    validation: {
      required: "域名、Hub 地址、域 Token 和本节点 Base URL 为必填项。",
      hubUrl: "Hub 地址必须是绝对 URL，且除 localhost 外必须使用 https。",
      baseUrl: "本节点 Base URL 必须是绝对 URL，且除 localhost 外必须使用 https。",
    },
    successRegistered: "集群域注册已完成。",
  },
  client: {
    name: "名称",
    desc: "描述",

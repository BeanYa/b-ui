export default {
  ...
  pages: {
    ...
    clusterScatterTaskResult: "Результат задачи кластера",
    multiLocationPing: "Мульти-локационный ping",
    webTerminal: "Веб-терминал",
  },
  webTerminal: {
    heroCopy: "Откройте терминал в браузере, чтобы проверить локальный серверный поток терминала, не покидая административный интерфейс.",
    connectionStatus: "Состояние подключения",
    interactiveStream: "Интерактивный поток TTY",
    transcript: "Журнал",
    connect: "Подключить",
    disconnect: "Отключить",
    placeholder: "Подключитесь, чтобы начать интерактивный сеанс терминала.",
    activationTitle: "Интерактивный веб-терминал",
    activationCopy: "Запустите живой сеанс терминала с вводом с клавиатуры, отображением курсора и потоковым выводом.",
    connectTitle: "Подключить веб-терминал?",
    connectCopy: "Будет открыт живой сеанс shell на сервере с интерактивным вводом с клавиатуры в браузере.",
    stay: "Остаться",
    leaveTitle: "Покинуть WebTerminal?",
    leaveCopy: "Переход со страницы закроет активный сеанс терминала и может прервать выполняемую на сервере команду или задачу.",
    leaveAndAbort: "Покинуть и прервать",
    terminalOpening: "Открытие подключения к терминалу...",
    terminalConnected: "Терминал подключен.",
    terminalDisconnected: "Терминал отключен.",
    terminalConnectionError: "Ошибка подключения к терминалу.",
    terminalMalformedMessage: "Некорректное сообщение терминала проигнорировано.",
    terminalAborted: "Терминал остановлен, потому что вы покинули страницу.",
    terminalStartPrompt: "Нажмите «Подключить», чтобы начать интерактивный сеанс терминала.",
    beforeUnload: "Выход из WebTerminal закроет активный сеанс терминала и прервет выполняемые задачи.",
  },
  main: {
    tiles: "Плитки",
    gauges: "Датчики",
    ...
    updatePanel: {
      ...
      confirmUpdate: "Обнаружен новый релиз. Подтвердите, чтобы обновить панель до последней опубликованной версии.",
      confirmForce: "Текущая версия уже совпадает с последней опубликованной версией. Используйте принудительное обновление для переустановки.",
      confirmDowngrade: "Текущая версия новее последнего опубликованного релиза. Продолжение принудительно переустановит последнюю опубликованную версию.",
      confirmUnknown: "Не удалось надежно сравнить текущую и последнюю версии. Продолжение выполнит принудительное обновление.",
      unsupported: "Автоматическое обновление панели не поддерживается в текущей среде выполнения.",
      progress: "Обновление",
      progressHint: "Во время перезапуска сервиса панель может быть временно недоступна.",
      running: "Задача обновления панели запущена. Дождитесь перезапуска сервиса и завершения установки.",
      completed: "Панель обновлена до целевой версии.",
      completedWithRefresh: "Панель обновлена до {version}. Обновите страницу, чтобы загрузить новую версию.",
      failed: "Не удалось обновить панель. Проверьте серверный журнал обновления.",
  ...
  actions: {
    ...
    save: "Сохранить",
    update: "Обновить",
    forceUpdate: "Принудительно обновить",
    submit: "Отправить",
    set: "Установить",
  ...
  login: {
    title: "Вход",
    subtitle: "Войдите в панель управления B-UI с учетной записью администратора.",
  ...
  clusterCenter: {
    ...
    heroCopy: "Присоединяйте панель к существующим доменам Hub, просматривайте зеркалированные узлы и запускайте ручную синхронизацию из одной панели.",
    metaNoDomain: "Домен не выбран",
    confirmTitle: "Подтверждение регистрации",
    domainsTitle: "Домены",
    noDomains: "Пока нет присоединённых доменов.",
    ...
    validation: {
      ...
      displayName: "Отображаемое имя обязательно.",
      invalidJoinUri: "Неверный формат URI. Проверьте его и повторите попытку.",
    },
    displayName: "Отображаемое имя",
    displayNameHint: "Понятная метка для этого узла в панелях управления.",
    alreadyExists: "Узел с таким же Base URL уже существует в этом домене.",
    alreadyExistsHint: "Он будет считаться тем же сервером. Получить данные домена и сопоставить этот сервер с локальным узлом?",

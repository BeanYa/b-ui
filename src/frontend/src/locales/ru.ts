export default {
  ...
  clusterCenter: {
    ...
    heroCopy: "Регистрируйте домены в Hub, просматривайте зеркалированные узлы и запускайте ручную синхронизацию из одной панели.",
    metaNoDomain: "Домен не выбран",
    domainsTitle: "Домены",
    noDomains: "Пока нет зарегистрированных доменов.",
    ...
    dialogTitle: "Зарегистрировать / присоединить домен",
    fields: {
      domain: "Домен",
      hubUrl: "URL Hub",
      token: "Токен домена",
      baseUrl: "Base URL этого узла",
    ...
    actions: {
      register: "Зарегистрировать / присоединить домен",
    ...
    validation: {
      required: "Домен, URL Hub, токен домена и Base URL этого узла обязательны.",
      hubUrl: "URL Hub должен быть абсолютным и использовать https, кроме localhost.",
      baseUrl: "Base URL этого узла должен быть абсолютным и использовать https, кроме localhost.",
    },
    successRegistered: "Регистрация домена кластера завершена.",
  },
  client: {
    name: "Имя",
    desc: "Описание",

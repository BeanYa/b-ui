  ...
  <v-dialog class="app-dialog app-dialog--wide" transition="dialog-bottom-transition" width="800">
    <v-card class="rounded-lg">
      ...
      <v-card-text class="app-dialog__body">
        ...
        <v-card class="app-form-card" subtitle="Route" v-if="ruleData.action == 'route'">
          <v-row>
            <v-col cols="12" sm="6" md="4">
              <v-select
        ...
        <v-card class="app-form-card" subtitle="Route Option" v-if="ruleData.action == 'route-options'">
          <v-row>
            <v-col cols="12" sm="6" md="4">

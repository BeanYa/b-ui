<template>
  <div class="app-page">
    ...
    <v-row class="app-grid">
      <v-col class="app-page__section-title" cols="12">{{ $t('pages.basics') }}</v-col>
    <v-col cols="12">
      <v-row>
    ...
    <v-row class="app-grid">
      <v-col class="app-page__section-title" cols="12">{{ $t('dns.title') }}</v-col>
      <v-col cols="12" md="6" lg="4" xl="3" v-for="(item, index) in <any[]>dns.servers" :key="item.id">
    ...
    <v-row class="app-grid">
      <v-col class="app-page__section-title" cols="12">{{ $t('dns.rule.title') }}</v-col>
      <v-col cols="12" md="6" lg="4" xl="3" v-for="(item, index) in <any[]>dnsRules"
      :key="item.id"
      :draggable="true"

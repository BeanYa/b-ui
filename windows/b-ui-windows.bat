...
REM B-UI Windows Control Script
REM This script provides a menu-driven interface for managing B-UI on Windows

cd /d "%~dp0"
set "SERVICE_NAME=b-ui"
set "INSTALL_DIR=%BUI_HOME%"
if "%INSTALL_DIR%"=="" set "INSTALL_DIR=C:\Program Files\b-ui"

:menu
cls
echo ========================================
echo B-UI Windows Control Panel
echo ========================================
echo.
echo Current directory: %INSTALL_DIR%
echo.
echo 1. Start B-UI Service
echo 2. Stop B-UI Service
echo 3. Restart B-UI Service
echo 4. Check Service Status
echo 5. View Service Logs
echo 6. Open Panel in Browser
echo 7. Run B-UI Manually
...
:check_status
echo Checking B-UI service status...
...
:open_panel
echo Opening B-UI panel in browser...
...
:exit
echo Thank you for using B-UI Windows Control Panel!
exit /b 0
